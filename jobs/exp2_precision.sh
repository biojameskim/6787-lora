#!/bin/bash
#SBATCH -J exp2_prec
#SBATCH -o /share/j_sun/jjk297/repos/6787-lora/slurm/exp2_%A_%a.out
#SBATCH -e /share/j_sun/jjk297/repos/6787-lora/slurm/exp2_%A_%a.err
#SBATCH -N 1
